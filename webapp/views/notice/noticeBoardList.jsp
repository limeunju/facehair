		...
		<div class="container">
			...
			<c:if test="${!empty member && member.mlevel == 2 }">
				<a class="btn btn-default pull-right"
					style="background: #ff666f; border: #ff666f; color: snow;"
					href="${pageContext.request.contextPath}/views/notice/noticeInsertForm.jsp">글쓰기</a>
			</c:if>
		...
		<script>
			$(function() {
				$("#listArea td")
						.click(
								function() {
									var bno = $(this).parent().find("input")
											.val();
									location.href = "${pageContext.request.contextPath}/selectOne.no?bno="
											+ bno;
								});
			});
		</script>
