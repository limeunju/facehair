...
<br />
    <div class="row">
        ...
        <div class="col-xs-8 col-md-8">
            <h2 class="text-center" style="color: white">QnA 상세 조회</h2>
            <hr>
            <p>&nbsp;</p>
            <div class="table table-responsive" style="overflow-x:hidden;">
                <table class="table">
                    <tr>
                        <th width= "200px" class="success" style="text-align: center; background: #ff666f;">QnA 글 제목</th>
                        <td style="text-align: center;">${qna.qtitle}</td>
                    </tr>

                    <tr>
                        <th class="success" style="text-align: center; background: #ff666f;">QnA 글 번호</th>
                        <td style="text-align: center;">${qna.qno}</td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: center;">${qna.qcontent}</td>
                    </tr>
	...
	<script>
		function golist(){
				location.href="${pageContext.request.contextPath}/adminSelectQnaList.do"
		};
	</script>
