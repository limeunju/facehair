...
<br />
    <h1 class="text-center" style="color: white;">신고글 게시물 목록</h1>
    <hr>
    <p>&nbsp;</p>
<div class="container">
    <table class="table table-striped type10 table-hover" id="listArea">
        <thead>
            <tr>
                <th style="text-align:center" class="reportnum1">신고 번호</th>
                <th style="text-align:center" class="reportnum1">신고 게시물 번호</th>
        ...
        <c:forEach var="report" items="${list}">
        	<tr>
			<td>
			<input style="text-align:center" type="hidden" value="${report.repno}">
			${report.repno}
			</td>
			<td style="text-align:center">${report.bno}</td>
			<td style="text-align:center">${report.repdate}</td>
			</tr>
		</c:forEach>
			</tbody>
    </table>
		...
		<div class="pagingArea" align="center">
			<c:url var="selectlist" value="selectBoardReportList.do"/>
...
<script>
		$(function(){
			$("#listArea td").click(function(){
				var repno = $(this).parent().find("input").val();
				location.href="${pageContext.request.contextPath}/selectBoardReportOne.do?repno=" + repno;
			});
		});
		</script>
