...
<br />
    <h1 class="text-center" style="color: white;"> 댓글 신고 게시물 목록</h1>
    <hr>
    <p>&nbsp;</p>
<div class="container">
    <table class="table table-striped type10 table-hover" id="listArea">
        <thead>
            <tr>
                ...
                <th style="text-align:center" class="creportnum1">댓글 번호</th>
                <th style="text-align:center" class="creportnum1">작성자</th>
                <th style="text-align:center">날짜</th>
            </tr>
        </thead>
         
        <c:forEach var="creport" items="${list}">
			<tr>
			<td style="text-align:center">
			<input type="hidden" value="${creport.crepno}">
			${creport.crepno}
			</td>				<td style="text-align:center">${creport.cno}</td>
		...
		<div class="pagingArea" align="center">
			<c:url var="selectlist" value="selectCommentReportList.do"/>
...
<script>
	$(function(){
		$("#listArea td").click(function(){
			var crepno = $(this).parent().find("input").val();
			location.href="${pageContext.request.contextPath}/selectCommentReportOne.do?crepno=" + crepno;
		});
	});
</script>
